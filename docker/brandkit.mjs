...
function describeTone(kit) {
  ...
  return traits.length === 0 ? "balanced, marketplace-friendly" : traits.join(", ");
}

function insightHighlights(insights) {
...
export function applyBrandKit(brandKit, productContext, insights) {
